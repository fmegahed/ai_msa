...
The *mean ensemble agreement* with the ground truth labels is **`r round(mean_ensembled_agreement, digits = 3)`**.

## Prompt Sensitivity Analysis

In this section, we will conduct a prompt sensitivity analysis to assess the impact of the prompt on the binary classification labels. We will evaluate the agreement with the `gold standard` and `ground truth` labels for a simpler prompt and compare the results.
