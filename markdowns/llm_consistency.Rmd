...
binary_classification_results |> 
  ...
  ggplot2::labs(
    ...
    caption = stringr::str_wrap(
      "Notes: The experiment was run on a sample of ~1400 news articles labelled as positive or negative by the StockNewsAPI. The text and titles of thoses articles were then passed to the LLMs for binary classification on Sept 26-29, 2024.",
      width = 120)
  ) +
  # Customize theme
...
ggplot2::ggsave("../figs/binary_classification_bar_chart.png", width = 6, height = 9, dpi = 600)
